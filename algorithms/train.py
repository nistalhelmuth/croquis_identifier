...
pd.DataFrame(thetas[0].reshape(1,-1)).to_csv('../csvFiles/1000/thetas.csv', mode='a',header=False, index=False)
pd.DataFrame(thetas[1].reshape(1,-1)).to_csv('../csvFiles/1000/thetas.csv', mode='a',header=False, index=False)
pd.DataFrame(thetas[2].reshape(1,-1)).to_csv('../csvFiles/1000/thetas.csv', mode='a',header=False, index=False)
pd.DataFrame(thetas[3].reshape(1,-1)).to_csv('../csvFiles/1000/thetas.csv', mode='a',header=False, index=False)
